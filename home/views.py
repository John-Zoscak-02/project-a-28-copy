...
CAL_ID = 'https://calendar.google.com/calendar/embed?src=c_8dc9a28038e69f7797ebdada5d7a0742a88425879517b38502e62af3ae0976a9%40group.calendar.google.com&ctz=America%2FNew_York'
...
class ProfileView(generic.DetailView):
    ...
    def profile(request):
        ...
        # Create Events
        for event in get_events(request.get_object().schedule.classes):
...
def add_section_landing(request):
    if request.method == 'POST':
        current_user_profile = request.user.profile
        schedule = Schedule.objects.get(profile=current_user_profile)[0]
