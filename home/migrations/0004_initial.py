# Generated by Django 4.1.1 on 2022-10-29 06:27
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('home', '0003_delete_aboutus_delete_calendar_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('friends', models.ManyToManyField(to='home.profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='schedule', to='home.profile')),
            ],
        ),
        migrations.CreateModel(
            name='Section',
            fields=[
                ...
                ('schedules', models.ManyToManyField(to='home.schedule')),
            ],
        ),
        migrations.AddField(
            model_name='course',
